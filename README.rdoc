...
- Added translation generator (models and migrations)
...
Also you can set only 

 class Document < ActiveRecord::Base
   translate_columns :title, :sub_title, :body
 end

...for some models. And use generator
 
 script/generate translation

It creates necessary migrations and models for models with option translate_columns.
Also it set has_many associaton with model and translate model.
